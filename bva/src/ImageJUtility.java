...
/**
 * Utility class for working with ImageJ specific data types.
 */
public class ImageJUtility {
    ...
    public static int[][] convertFrom1DByteArr(byte[] pixels, int width, int height) {
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                inArray2D[x][y] = pixels[pixelIdx1D];
                if (inArray2D[x][y] < 0) {
                    inArray2D[x][y] += 256;
                } // if
                pixelIdx1D++;
     ...
     *
     * @param inArr  The 2d input image.
     * @param width  The width of the image.
     * @param height The height of the image.
     * @return The resulting byte representation.
     */
    ...
    /**
     * @param inByteArr The 1D input image.
     * @param width     The width of the image.
     * @param height    The height of the image.
     * @param title     The window title.
     */
     ...
     *
     * @param ip            The image processor from Plugins run method.
     * @param width         The width of the image.
     * @param height        The height of the image.
     * @param numOfChannels The numbers of channels of the image (e.g. RGB = 3).
     * @return The resulting 2D image with multiple channels. (format: [width][height][channels])
     */
     ...
     *
     * @param inImg     The input 2D image with multiple channels
     * @param width     The width of the image.
     * @param height    The height of the image.
     * @param channelID The channel to be extracted.
     * @return A 2D representation of the channel
     */
     ...
     *
     * @param inImg      The image to which the channel should be assigned
     * @param width      The width of the image.
     * @param height     The height of the image.
     * @param channelID  in [0;2]
     * @param channelArr The image that should be used as channel.
     * @return The resulting image with the channel assign. Note: same reference as inImg.
     */
